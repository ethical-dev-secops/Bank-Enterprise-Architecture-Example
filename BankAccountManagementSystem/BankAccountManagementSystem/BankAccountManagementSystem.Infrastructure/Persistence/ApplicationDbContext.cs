...
using BankAccountManagementSystem.Infrastructure.Persistence.Configurations;
...
namespace BankAccountManagementSystem.Infrastructure.Persistence
{
    public class ApplicationDbContext : DbContext, IUnitOfWork
    {
        ...
        public DbSet<ChequeAccount> ChequeAccounts { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new ChequeAccountConfiguration());
